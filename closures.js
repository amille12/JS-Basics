...
/*
  ...
  Above you have a function named counter. Examine the function (without running the code) then below write what you expect to happen when the funciton 
  is invoked. *Hint: setTimeout calls a function or evaluates an expression after a specified number of milliseconds.

  //Answer Here

The function will run up to five times, with a delay of 10 seconds in between.
  ...
  Was your answer right or wrong?
    ...
    //Answer Here
No, it is not listing the numbers as it should.
